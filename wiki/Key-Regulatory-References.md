...
Official regulatory texts, guidance documents, and authoritative sources for EU AI compliance.
...
|---|---|---|
| **Guidelines on Prohibited AI Practices** | European Commission (C(2025) 895, Feb 2025) | Detailed interpretation of Article 5 prohibitions |
...
The EU Charter underpins the FRIA and many AI Act provisions. Key articles for AI compliance:
...
| 27–31 | Workers' rights |
| 41 | Right to good administration |
| 47 | Right to an effective remedy and to a fair trial |

[Full text of the EU Charter](https://eur-lex.europa.eu/eli/treaty/char_2012/oj)
...
|---|---|
| **European Commission — AI policy** | [digital-strategy.ec.europa.eu/en/policies/artificial-intelligence](https://digital-strategy.ec.europa.eu/en/policies/artificial-intelligence) |
| **European Commission — AI Act governance** | [digital-strategy.ec.europa.eu/en/policies/ai-act-governance-and-enforcement](https://digital-strategy.ec.europa.eu/en/policies/ai-act-governance-and-enforcement) |
| **EU AI Act full text (navigable)** | [artificialintelligenceact.eu](https://artificialintelligenceact.eu/) |
...
| **IAPP — EU AI Act Regulatory Directory** | [iapp.org/resources/article/eu-ai-act-regulatory-directory](https://iapp.org/resources/article/eu-ai-act-regulatory-directory/) |

## Academic and Research References

| Topic | Reference |
|---|---|
| **Fairness impossibility** | Chouldechova, A. (2017). "Fair Prediction with Disparate Impact: A Study of Bias in Recidivism Prediction Instruments." *Big Data* 5(2). |
| **Fairness impossibility** | Kleinberg, J., Mullainathan, S., & Raghavan, M. (2016). "Inherent Trade-Offs in the Fair Determination of Risk Scores." *ITCS 2017*. |
| **Shadow AI statistics** | Gartner Research (2024). "By 2026, 80% of employees will use generative AI for work without company approval." |
| **Breach costs** | IBM (2024). *Cost of a Data Breach Report*. |
| **AI threat landscape** | ENISA (2024). *AI Threat Landscape*. |
