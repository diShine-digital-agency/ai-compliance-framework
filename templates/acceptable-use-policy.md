...
- **Regulatory Compliance (EU AI Act):** Ensuring [Company Name] does not inadvertently deploy prohibited or high-risk AI systems without proper governance. *Note: consult the European Commission's published [Article 5 prohibited-practice guidelines](https://digital-strategy.ec.europa.eu/en/policies/ai-act) for the current scope of "subliminal techniques", manipulative recommender systems, and other prohibitions.*
...
> **Framework Navigation:** This document is part of the [AI Compliance Framework](../README.md) by [diShine Digital Agency](https://dishine.it). It is used in **Phase 1 — Assess & Contain**, **Step 1.2: Establish the Baseline Rules**. For the full deployment sequence, rationale, and ownership guide, see the [Step-by-Step User Guide](../guides/how-to-use-this-framework.md).
